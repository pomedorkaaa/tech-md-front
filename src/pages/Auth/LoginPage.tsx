    ...
    <main className="flex-1 flex items-center justify-center px-6 py-12 relative overflow-hidden min-h-screen">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-text-secondary font-sans text-sm tracking-wide">
            The heart of the local IT ecosystem.
          </p>
        </div>
        ...
        <div className="bg-charcoal rounded-xl shadow-2xl p-8 md:p-10 border border-border relative overflow-hidden">
          <form className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a
                  className="text-xs font-sans text-primary hover:text-blue-400 transition-colors"
                  href="#"
                >
                  Forgot?
                </a>
          ...
          <div className="relative my-8 z-10">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-tighter">
              <span className="bg-charcoal px-4 text-text-secondary font-sans font-medium">
                Or continue with
              </span>
            </div>
          </div>
